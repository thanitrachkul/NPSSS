...
const StudentList: React.FC<StudentListProps> = ({ 
  ...
  const handleExport = async () => {
    ...
    const generateSheet = (sheetName: string, data: RankedStudent[]) => {
        ...
        const totalColumns = 10 + subjects.length;
        ...
        const headerValues = [
            'อันดับที่', 'เลขที่ผู้สมัคร', 'คำนำหน้า', 'ชื่อ', 'นามสกุล', 'เขตพื้นที่',
        ...
        data.forEach(student => {
            ...
            const row = worksheet.addRow({
                ...
                residence: student.residence === 'IN_DISTRICT' ? 'ในเขต' : 'นอกเขต',
            ...
            <table className="min-w-[1200px] w-full divide-y divide-gray-100 print:min-w-0">
              ...
              <tbody className="bg-white divide-y divide-gray-50">
                {paginatedStudents.length > 0 ? paginatedStudents.map((student) => {
                   ...
                   return (
                  <tr key={student.id} onClick={() => handleRowClick(student)} className="hover:bg-gray-50 transition-colors group cursor-pointer print:break-inside-avoid">
                 ...
                 <div className="space-y-6">
                     ...
                     <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
                            ...
                            <span className="text-sm font-bold text-gray-800">{selectedStudentDetail.totalScore}</span>
                        </div>
                     </div>
